    ...
    <div x-data="loginForm()" class="w-full max-w-[450px] animate-card-fade">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-800 shadow-lg p-6 sm:p-8">
            ...
            <div x-show="errorMessage" x-cloak
                 class="mb-5 p-3.5 rounded-xl border border-red-200 bg-red-50 text-sm font-medium text-red-800 dark:border-red-900/40 dark:bg-red-950/20 dark:text-red-400 flex items-start gap-2.5">
                <svg class="h-5 w-5 text-red-600 dark:text-red-400 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center pt-0.5">
                    <label class="flex items-center gap-2.5 cursor-pointer" for="remember">
                        <input type="checkbox" name="remember" id="remember" x-model="remember" :disabled="loading"
                               class="h-5 w-5 rounded border-gray-300 bg-white text-blue-600 focus:ring-blue-500/20 dark:border-slate-700 dark:bg-slate-800">
