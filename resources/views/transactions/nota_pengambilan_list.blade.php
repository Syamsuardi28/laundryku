...
@section('content')
<x-ui.page-header title="Nota Pengambilan Laundry" subtitle="Cetak Nota Pengambilan untuk transaksi selesai" />
...
<div class="card mb-6 p-4">
    <form method="GET" class="flex flex-col gap-3 sm:flex-row">
        ...
        @if(request('search'))
        <a href="{{ route('transactions.nota-pengambilan') }}" class="btn-secondary">
        ...
        <table class="table-modern w-full text-sm">
            <thead>
                <tr>
                    ...
                    <th class="px-6 py-4 text-left">Tanggal Diambil</th>
            ...
            <tbody class="text-slate-600 dark:text-slate-300">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-xs font-semibold text-success">{{ $transaction->tanggal_diambil ? $transaction->tanggal_diambil->format('d/m/Y H:i') : '-' }}</td>
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('transactions.print-pengambilan', $transaction) }}" target="_blank"
                           class="inline-flex items-center rounded-lg bg-emerald-50 px-3 py-1.5 text-xs font-semibold text-emerald-600 hover:bg-emerald-100 transition-colors">
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center text-slate-400">
                        Tidak ada transaksi selesai yang siap dicetak Nota Pengambilannya.
                    </td>
                </tr>
                @endforelse
            </tbody>
